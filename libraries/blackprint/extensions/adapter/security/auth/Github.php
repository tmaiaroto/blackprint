 ...
 */
class Github extends \lithium\core\Object {

	/**
	 * Service name (lowercase, no special characters)
	 */
	protected $_service = 'github';
	...
	*/
	 ...
	 * User infos URL
	 */
	protected $_userInfoEndpoint = 'https://api.github.com/user';
	...
	public function check($request, array $options = array()) {
		...
		if(empty($request->query['code'])) {
		    ...
		    if(is_array($credentials) && isset($credentials['id'])) {
		    	$result = array(
		    		'socialLogin' => array(
			    		...
			    		'profilePicture' => $credentials['avatar_url']
		    		)
		    	);
		    }
	    	...
	    	$result['socialLogin']['serviceIcon'] = '<i class="fa fa-github"></i>';
	    	$result['socialLogin']['serviceUrl'] = 'http://www.github.com';
