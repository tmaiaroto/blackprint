...
class Dropbox extends \lithium\core\Object {
	 ...
	 */
	protected $_service = 'dropbox';

	/**
	 * Full service name. Title casing, spaces, etc.
	*/
	protected $_serviceName = 'Dropbox';

	/**
	 * User infos URL
	 */
	protected $_userInfoEndpoint = 'https://api.dropbox.com/1/account/info';
	...
	public function check($request, array $options = array()) {
		...
		if(empty($request->query['code'])) {
	    	...
	    	$result['socialLogin']['serviceIcon'] = '<i class="fa fa-dropbox"></i>';
	    	$result['socialLogin']['serviceUrl'] = 'http://www.dropbox.com';
