 ...
 */
class Google extends \lithium\core\Object {

	/**
	 * Service name (lowercase, no special characters)
	 */
	protected $_service = 'google';
	...
	*/
	 ...
	 * User infos URL
	 */
	protected $_userInfoEndpoint = 'https://www.googleapis.com/oauth2/v1/userinfo';
	...
	public function check($request, array $options = array()) {
		...
		if(empty($request->query['code'])) {
	    	...
	    	$result['socialLogin']['serviceIcon'] = '<i class="fa fa-google-plus"></i>';
	    	$result['socialLogin']['serviceUrl'] = 'http://plus.google.com';
